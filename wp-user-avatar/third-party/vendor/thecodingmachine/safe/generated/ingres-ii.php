...
use ProfilePressVendor\Safe\Exceptions\IngresiiException;
/**
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_autocommit($link);
    if ($result === \false) {
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_close($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_commit($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
function ingres_connect(string $database = null, string $username = null, string $password = null, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \ProfilePressVendor\ingres_connect($database, $username, $password, $options);
    } elseif ($password !== null) {
        $result = \ProfilePressVendor\ingres_connect($database, $username, $password);
    } elseif ($username !== null) {
        $result = \ProfilePressVendor\ingres_connect($database, $username);
    } elseif ($database !== null) {
        $result = \ProfilePressVendor\ingres_connect($database);
    } else {
        $result = \ProfilePressVendor\ingres_connect();
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
function ingres_execute($result, array $params = null, string $types = null): void
{
    error_clear_last();
    if ($types !== null) {
        $result = \ProfilePressVendor\ingres_execute($result, $params, $types);
    } elseif ($params !== null) {
        $result = \ProfilePressVendor\ingres_execute($result, $params);
    } else {
        $result = \ProfilePressVendor\ingres_execute($result);
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_field_name($result, $index);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_field_type($result, $index);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_free_result($result);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
function ingres_pconnect(string $database = null, string $username = null, string $password = null, array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \ProfilePressVendor\ingres_pconnect($database, $username, $password, $options);
    } elseif ($password !== null) {
        $result = \ProfilePressVendor\ingres_pconnect($database, $username, $password);
    } elseif ($username !== null) {
        $result = \ProfilePressVendor\ingres_pconnect($database, $username);
    } elseif ($database !== null) {
        $result = \ProfilePressVendor\ingres_pconnect($database);
    } else {
        $result = \ProfilePressVendor\ingres_pconnect();
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_result_seek($result, $position);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_rollback($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \ProfilePressVendor\ingres_set_environment($link, $options);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
